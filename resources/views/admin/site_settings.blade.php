                            ...
                            <div class="col-md-12">
								...
								<div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <form method="post" action="{{ route('admin.post-sitesettings') }}" class="form-horizontal" enctype="multipart/form-data">
											@csrf
											
											<div class="row form-group image-upload">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label">Header Logo</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="header_logo" name="header_logo" />
													<img id="header_logo_preview" src="#" alt="Preview" />
                                                </div>												
                                            </div>
